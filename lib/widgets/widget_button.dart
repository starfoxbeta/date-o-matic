...
class Button extends StatelessWidget {
  ...
  double width;
  Button({this.text, this.onTap, this.margin, this.width});
  @override
    ...
    return GestureDetector(
      child: Container(
        ...
        decoration: BoxDecoration(
            color: Color(0xFF2E5BFF), borderRadius: BorderRadius.circular(4.0)),
...
class CommonText extends StatelessWidget {
  ...
  CommonText({this.text, this.color, this.decoration});
  @override
  Widget build(BuildContext context) {
    return Text(
      text,
